...
import org.apache.cassandra.cql3.restrictions.SearchRestrictions.SearchContainsRestriction;
import org.apache.cassandra.cql3.restrictions.SearchRestrictions.SearchEQRestriction;
import org.apache.cassandra.cql3.restrictions.SearchRestrictions.SearchInRestrictionWithMarkers;
import org.apache.cassandra.cql3.restrictions.SearchRestrictions.SearchInRestrictionWithValues;
import org.apache.cassandra.cql3.restrictions.SearchRestrictions.SearchIsNotNullRestriction;
import org.apache.cassandra.cql3.restrictions.SearchRestrictions.SearchLikeRestriction;
import org.apache.cassandra.cql3.restrictions.SearchRestrictions.SearchSliceRestriction;
import org.apache.cassandra.cql3.restrictions.SingleColumnRestriction.ContainsRestriction;
import org.apache.cassandra.cql3.restrictions.SingleColumnRestriction.EQRestriction;
import org.apache.cassandra.cql3.restrictions.SingleColumnRestriction.InRestrictionWithMarker;
import org.apache.cassandra.cql3.restrictions.SingleColumnRestriction.InRestrictionWithValues;
import org.apache.cassandra.cql3.restrictions.SingleColumnRestriction.IsNotNullRestriction;
import org.apache.cassandra.cql3.restrictions.SingleColumnRestriction.LikeRestriction;
import org.apache.cassandra.cql3.restrictions.SingleColumnRestriction.SliceRestriction;
